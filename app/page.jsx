            ...
            >
              <div className="flex justify-between w-full">
                <input
                  ...
                  className="rounded-md bg-transparent focus:outline-none w-full placeholder:pl-1 placeholder:text-white text-white text-lg bg-red-500"
                  type="text"
                  placeholder="Busca tu ciudad"
                />
                <button onClick={fetchWeather}>
                  <BsSearch size={20} className="z-10" />
                </button>
              </div>
            </form>
          </div>
